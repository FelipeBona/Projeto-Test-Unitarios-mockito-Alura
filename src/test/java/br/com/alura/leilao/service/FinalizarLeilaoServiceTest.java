...
class FinalizarLeilaoServiceTest {
	...
	public void beforeEach() {
		...
		this.service = new FinalizarLeilaoService(leilaoDao, enviadordeEmail);
	...
	void deveriaEnviarEmailParaVencedorDoLeilao() {
		...
		Mockito.verify(enviadordeEmail).enviarEmailVencedorLeilao(lanceVencedor);
	}

	@Test
	void naoDeveriaEnviarEmailParaVencedorDoLeilaoEmCasoDeErroAoEncerraroLeialo() {
		List<Leilao> leiloes = leiloes();
